...
def MainTab():
    ...
    new_vector2_name_E = tk.Entry(main_tab, width=50)
    new_vector2_value_L = tk.Label(main_tab, text="Enter the values from the vector 2")
    new_vector2_value_E = tk.Entry(main_tab, width=50)
    ...
    new_vector3_name_E = tk.Entry(main_tab, width=50)
    new_vector3_value_L = tk.Label(main_tab, text="Enter the values from the vector 3")
    new_vector3_value_E = tk.Entry(main_tab, width=50, )
